      ...
      <Stack gap="md" style={{ minWidth: 1200, paddingBottom: 20 }}>
                  ...
                  <Stack gap="xs">
                    {filteredEstimates.map((estimate) => (
                      <Paper
                        ...
                        style={{
                          cursor: "pointer",
                          borderColor: estimate.id === selectedEstimateId ? "var(--accent)" : "var(--border)",
                ...
                {selectedEstimate ? (
                  <Stack gap="md">
                    ...
                    <Stack gap="xs">
                      ...
                      {breakdown && (
                        <SimpleGrid cols={2}>
                          <Paper withBorder p="xs" radius="md" bg="var(--panel)">
                            <Text size="xs" c="dimmed">
                              순공사비
                            </Text>
                            <Text fw={700}>{formatCurrency(breakdown.subtotal)}원</Text>
                          </Paper>
                          <Paper withBorder p="xs" radius="md" bg="var(--panel)">
                            <Text size="xs" c="dimmed">
                              총 합계
                            </Text>
                            <Text fw={700} c="var(--mantine-color-indigo-light-color)">
        ...
        >
          <Stack>
            <SegmentedControl
              value={addMode}
              onChange={(val) => setAddMode(val as "preset" | "material" | "manual")}
              data={[
            ...
            {addMode === "material" && (
              <>
                ...
                <SearchableSelect
                  ...
                  onChange={(val) => {
                    const mat = val ? materialMap.get(val) : undefined;
                    if (mat) {
